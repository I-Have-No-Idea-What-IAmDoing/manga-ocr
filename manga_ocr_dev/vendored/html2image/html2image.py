...
from .browsers import chrome, chrome_cdp, edge
from .browsers.browser import Browser, CDPBrowser
...
class Html2Image():
    ...
    def __init__(
        ...
        # Downstream uses CDPBrowser, so we can assume it is a CDPBrowser
    ...
    def screenshot_as_bytes(self, file, size=None):
        """ Takes a screenshot of a *previously loaded* file or string and returns it as bytes.
        ...
        return self.browser.screenshot_as_bytes(
            input=file,
            size=size,
        )
