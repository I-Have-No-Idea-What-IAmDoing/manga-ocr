...
from manga_ocr_dev.synthetic_data_generator.renderer import Renderer, get_css, crop_by_alpha
...
def test_render_text(renderer):
    ...
    lines = ['test']
    img, params = renderer.render(lines, override_css_params={'font_path': 'dummy.ttf'})
